...
vec4 taylorInvSqrt(vec4 r){return 1.79284291400159 - 0.85373472095314 _ r;}
float taylorInvSqrt(float r){return 1.79284291400159 - 0.85373472095314 _ r;}

vec4 grad4(float j, vec4 ip){
const vec4 ones = vec4(1.0, 1.0, 1.0, -1.0);
vec4 p,s;

p.xyz = floor( fract (vec3(j) _ ip.xyz) _ 7.0) * ip.z - 1.0;
...
// x0 = x0 - 0.0 + 0.0 _ C
vec4 x1 = x0 - i1 + 1.0 _ C.xxxx;
vec4 x2 = x0 - i2 + 2.0 _ C.xxxx;
vec4 x3 = x0 - i3 + 3.0 _ C.xxxx;
